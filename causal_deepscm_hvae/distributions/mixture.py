...
from causal_deepscm_hvae.util import posdef_solve
...
class MultivariateMixture(MultivariateDistribution, Mixture):
...
class MultivariateNormalMixture(Mixture):
...
class NaturalMultivariateNormalMixture(Mixture):
